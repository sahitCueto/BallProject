...
public class PongCourt extends JPanel {
    ...
    public PongCourt() {
        ...
        setFocusable(true);
        lives_jtp = new JTextPane();
        level_jtp = new JTextPane();
        level_jtp = new JTextPane();
        score_jtp = new JTextPane();
        bricks_left_jtp = new JTextPane();
        level_jtp.setText("Level: 1");
        ...
        music = new Sounds("C:\\Users\\ESTUDIANTE\\Workspace\\BallProject\\BrickBreaker\\ImgandSound\\DigitalStream.wav");
        music.playSound();
    }
    ...
    void tick() {
        ...
        for (int i = 0; i < balls.size(); i++) {
            ...
            if (started && paddle_ball != Intersection.NONE) {
                (new Sounds("C:\\Users\\ESTUDIANTE\\Workspace\\BallProject\\BrickBreaker\\ImgandSound\\WoodWhack.wav")).playSoundOnce();
